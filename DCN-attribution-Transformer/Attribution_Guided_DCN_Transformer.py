"""Define the attribution-guided deformable CNN-Transformer model."""
...
class AttributionGuidedDCNTransformer(nn.Module):
    """Fuse DeepLIFT-derived spatial guidance with deformable features."""
...
if __name__ == "__main__":
    ...
    run_model_pipeline(
        workflow_model,
        "attribution_guided_dcn_transformer",
        pipeline_defaults={
            "epochs": 120,
            "patience": 20,
            "weight_decay": 0.05,
            "factor_loss_weight": 0.20,
            "transformer_loss_weight": 0.0,
            "label_smoothing": 0.05,
            "factor_l1_weight": 1e-4,
            "factor_l2_weight": 1e-4,
        },
    )
